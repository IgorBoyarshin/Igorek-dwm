...
enum { SchemeNorm, SchemeSel, SchemeTest3, SchemeTest4, SchemeTest5, SchemeTest6, SchemeTest7, SchemeTest8, SchemeTest9 }; /* color schemes */
...
drawbar(Monitor *m)
{
	...
	if ((w = m->ww - tw - x) > bh) {
		if (m->sel) {
            ...
            // Status between tags and blocks
			drw_setscheme(drw, scheme[SchemeNorm]);
